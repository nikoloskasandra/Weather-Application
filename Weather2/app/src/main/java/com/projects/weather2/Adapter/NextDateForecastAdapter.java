...
public class NextDateForecastAdapter extends RecyclerView.Adapter<NextDateForecastAdapter.ViewHolder> {

    public Context                      context;
    public ArrayList<WeatherForecast>   weatherForecastArrayList;


    public NextDateForecastAdapter(Context context, ArrayList<WeatherForecast> weatherForecastArrayList) {
    ...
    @NonNull
    @Override
    public com.projects.weather2.Adapter.NextDateForecastAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.next_day_forecast_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.projects.weather2.Adapter.NextDateForecastAdapter.ViewHolder holder, int position) {
        ...
        holder.temperatureTv.setText(weatherForecast.getTemperatureInCelsius());
