...
import com.projects.weather2.Adapter.CurrentDateForecastFahrenheitAdapter;
import com.projects.weather2.Adapter.NextDateForecastAdapter;
import com.projects.weather2.Adapter.NextDateForecastFahrenheitAdapter;
...
public class FahrenheitFragment extends Fragment {
    ...
    private CurrentDateForecastFahrenheitAdapter    currentDateForecastFahrenheitAdapter;

    private ArrayList<WeatherForecast>              weatherForecastArrayList;
    private NextDateForecastFahrenheitAdapter       nextDateForecastFahrenheitAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fahrenheit, container, false);
        ...
        currentDateForecastFahrenheitAdapter    = new CurrentDateForecastFahrenheitAdapter(getActivity(),todaysWeatherForecastArrayList);
        ...
        nextDateForecastFahrenheitAdapter       = new NextDateForecastFahrenheitAdapter(getActivity(), weatherForecastArrayList);
    ...
    private void findLocation() {
        ...
        //PERMISSIONS: if the permissions are not granted -> (ask for permissions)
        if(ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_COARSE_LOCATION)!= PackageManager.PERMISSION_GRANTED
            ...
            //PERMISSIONS:if the permissions are granted -> next step: find current location
                            ...
                            (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                                ...
                                private void rvCurrentDayForecast(JSONObject response) throws JSONException {
                                    ...
                                    for(int i = 0; i<JSONArrayForcastPerHour.length(); i++){
                                        ...
                                        recyclerViewTodayForecast.setAdapter(currentDateForecastFahrenheitAdapter);

                                    }

                                    //we should notify that the data for adapter is changed
                                    currentDateForecastFahrenheitAdapter.notifyDataSetChanged();
                                ...
                                private void rvNextDaysForecast(JSONObject response) throws JSONException {
                                    ...
                                    for(int i=0; i< JSONArrayNextDays.length(); i++) {
                                        ...
                                        getRecyclerViewNextDaysForecast.setAdapter(nextDateForecastFahrenheitAdapter);


                                    }
                                    nextDateForecastFahrenheitAdapter.notifyDataSetChanged();
