...
public class CurrentDateForecastFahrenheitAdapter extends RecyclerView.Adapter<CurrentDateForecastFahrenheitAdapter.ViewHolder> {


    private Context             context;
    private ArrayList<Weather>  todaysForecast;

    public CurrentDateForecastFahrenheitAdapter(Context context, ArrayList<Weather> todaysForecast) {
    ...
    @NonNull
    @Override
    public CurrentDateForecastFahrenheitAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.today_forecast_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CurrentDateForecastFahrenheitAdapter.ViewHolder holder, int position) {
        ...
        holder.temperatureTv.setText(weather.getGetTemperatureInFahrenheit() + "°");
